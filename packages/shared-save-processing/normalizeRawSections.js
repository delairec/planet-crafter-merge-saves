...
/**
 * Warning codes reported when a save had to be adapted to the current format. A code is a contract,
 * translated by its consumer into the sentence shown to the user; the code itself is never displayed.
 */
