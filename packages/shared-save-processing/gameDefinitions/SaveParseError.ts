/**
 * A failure met while reading a save. A line that cannot be read carries where it was found and
 * the text that defeated the reader; a failure about the file as a whole carries only its detail.
 *
